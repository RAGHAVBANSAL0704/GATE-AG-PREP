    ...
    <div className="space-y-6 animate-in fade-in duration-200 min-w-0 max-w-full overflow-hidden">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-5 sm:p-6 shadow-xs space-y-5">
        ...
        <div className="space-y-2.5 pt-1">
          ...
          {searchQuery && (
            <div className="flex flex-wrap items-center gap-1.5 pb-1 animate-fadeIn text-xs">
        ...
        {/* Fully Responsive Suite Navigation Tabs (All 8 Tools fully readable) */}
          ...
          {subTabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex-1 sm:flex-initial inline-flex items-center justify-center sm:justify-start gap-2 px-3.5 py-2.5 rounded-2xl text-xs font-extrabold transition border cursor-pointer whitespace-nowrap min-h-[42px] ${
                  isActive
