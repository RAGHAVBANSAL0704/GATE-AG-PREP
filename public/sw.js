...
const STATIC_CACHE = 'gate-ag-static-v1.0.3';
const RUNTIME_CACHE = 'gate-ag-runtime-v1.0.3';
const IMAGES_CACHE = 'gate-ag-images-v1.0.3';
const FONTS_CACHE = 'gate-ag-fonts-v1.0.3';
